...
import * as projectspecificAnnotationCardText from '../../texteditor-ng/projectspecific/annotationCard';
import * as projectspecificAnnotationCardImage from '../../imageeditor-ng/projectspecific/annotationCard';
...
describe('selecting an annotation', () => {
  ...
  describe('successfully and rendering it', () => {
    beforeAll(() => {
      ...
      jest.spyOn(projectspecificAnnotationCardText, 'changeLabel').mockImplementation((param) => param + ': ');
      jest.spyOn(projectspecificAnnotationCardImage, 'changeLabel').mockImplementation((param) => param + ': ');
    });
    beforeEach(() => {
      window.EDITORTYPE = 'DEFAULT';
    });
    it('returns the annotation and renders it in a div for the texteditor', async () => {
      ...
      jest.replaceProperty(projectspecificAnnotationCardText, 'headerFieldsArray', [
        'creators',
        'modified',
        'generator',
        'motivation',
      ...
      jest.replaceProperty(projectspecificAnnotationCardText, 'omitFieldsArray', [
        'type',
        'selector',
        'fullJson',
        'annotationId',
    ...
    it('returns the annotation and renders it in a div for the imageeditor', async () => {
      ...
      $container.appendChild($child);
      document.body.appendChild($container);
      jest.replaceProperty(projectspecificAnnotationCardImage, 'headerFieldsArray', [
        'created',
        'modified',
        'generator',
        'motivation',
      ...
      jest.replaceProperty(projectspecificAnnotationCardImage, 'omitFieldsArray', [
        'type',
        'selector',
        'fullJson',
        'annotationId',
      ...
      jest.replaceProperty(projectspecificAnnotationCardImage, 'editableFieldsArray', ['describing']);
      const selectedAnnotation = await selectAnnotation('event', 'annoId', {});
      const filledCard = `<div id="annotationCard" class="card card-body row-gap-2"><div id="iconRowTop" class="text-end"><i id="addBody" class="bx bx-plus" data-bs-toggle="tooltip" data-bs-title="Add body" aria-label="Add another body to the annotation" data-bs-original-title="Add another body to the annotation"></i><i id="deleteAnnotation" class="bx bx-trash" data-bs-toggle="tooltip" data-bs-title="Delete annotation" aria-label="Delete" data-bs-original-title="Delete"></i></div><div><div class="form-group jsonform-error-created"><label for="-elt-created">created</label><div class="controls"><input type="text" class="form-control" name="created" value="2024-07-09T07:03:37.000Z" id="-elt-created" aria-label="created"><span class="help-block jsonform-errortext" style="display:none;"></span></div></div><div class="form-group jsonform-error-modified"><label for="-elt-modified">modified</label><div class="controls"><input type="text" class="form-control" name="modified" value="2024-07-09T07:03:37.000Z" id="-elt-modified" aria-label="modified"><span class="help-block jsonform-errortext" style="display:none;"></span></div></div></div><div id="topButtonContainer"></div><div class="card"><div class="row"><div id="2741aaf0-0fac-4690-81b4-8d0301f40a97" class="d-flex align-items-center formBodyDiv"><div id="iconRow0"><i id="expandexpand0" class="bx bx-chevron-right" data-bs-toggle="tooltip" data-bs-title="Expand body" aria-label="Expand" data-bs-original-title="Expand"></i><i id="delete0" class="bx bx-trash" data-bs-toggle="tooltip" data-bs-title="Delete body" aria-label="Delete" data-bs-original-title="Delete"></i></div><form id="formHorizontal2741aaf0-0fac-4690-81b4-8d0301f40a97" class="horizontalFormForm flex-fill" style="margin-left: 0.5rem;"><div><div class="form-group jsonform-error-value horizontalFormDiv"><label for="-elt-value">describing: </label><div class="controls"><textarea id="-elt-value" name="value" style="height:150px;width:100%;" aria-label="describing: ">judgment long text text text text text text text text text text</textarea><span class="help-block jsonform-errortext" style="display:none;"></span></div></div><div class="form-group jsonform-error-id d-none"><label for="-elt-id">id</label><div class="controls"><input type="text" class="form-control" name="id" value="2741aaf0-0fac-4690-81b4-8d0301f40a97" id="-elt-id" aria-label="id"><span class="help-block jsonform-errortext" style="display:none;"></span></div></div><input type="submit" class="btn horizontalFormInput btn-success" value="Save" disabled=""></div></form></div></div><div class="row collapse"><form id="form2741aaf0-0fac-4690-81b4-8d0301f40a97" class="col"><div><fieldset class="form-group jsonform-error-  "><div class="form-group jsonform-error-id"><label for="-elt-id">id</label><div class="controls"><input type="text" class="form-control" name="id" value="2741aaf0-0fac-4690-81b4-8d0301f40a97" id="-elt-id" aria-label="id"><span class="help-block jsonform-errortext" style="display:none;"></span></div></div><div class="form-group jsonform-error-creators"><label for="-elt-creators">creators</label><div class="controls"><div id="-elt-creators"><ul class="_jsonform-array-ul" style="list-style-type:none;"><li data-idx="0"><div class="form-group jsonform-error-creators[0]"><label for="-elt-creators[0]">creators</label><div class="controls"><input type="text" class="form-control" name="creators[0]" value="Tester" id="-elt-creators[0]" aria-label="creators"><span class="help-block jsonform-errortext" style="display:none;"></span></div></div></li></ul><span class="_jsonform-array-buttons"><a href="#" class="btn btn-default _jsonform-array-addmore"><i class="glyphicon glyphicon-plus-sign" title="Add new"></i></a> <a href="#" class="btn btn-default _jsonform-array-deletelast"><i class="glyphicon glyphicon-minus-sign" title="Delete last"></i></a></span></div><span class="help-block jsonform-errortext" style="display:none;"></span></div></div><div class="form-group jsonform-error-created"><label for="-elt-created">created</label><div class="controls"><input type="text" class="form-control" name="created" value="2024-07-09T07:03:37.000Z" id="-elt-created" aria-label="created"><span class="help-block jsonform-errortext" style="display:none;"></span></div></div><div class="form-group jsonform-error-modified"><label for="-elt-modified">modified</label><div class="controls"><input type="text" class="form-control" name="modified" value="2024-07-09T07:03:37.000Z" id="-elt-modified" aria-label="modified"><span class="help-block jsonform-errortext" style="display:none;"></span></div></div><div class="form-group jsonform-error-purpose"><label for="-elt-purpose">purpose</label><div class="controls"><input type="text" class="form-control" name="purpose" value="describing" id="-elt-purpose" aria-label="purpose"><span class="help-block jsonform-errortext" style="display:none;"></span></div></div><div class="form-group jsonform-error-value"><label for="-elt-value">value</label><div class="controls"><input type="text" class="form-control" name="value" value="judgment long text text text text text text text text text text" id="-elt-value" aria-label="value"><span class="help-block jsonform-errortext" style="display:none;"></span></div></div></fieldset><input type="submit" class="btn btn-primary " value="Update + Save"></div></form></div></div><div class="card"><div class="row"><div id="a1e9750a-e0ce-4e38-8372-406e5c8d0d94" class="d-flex align-items-center formBodyDiv"><div id="iconRow1"><i id="expandexpand1" class="bx bx-chevron-right" data-bs-toggle="tooltip" data-bs-title="Expand body" aria-label="Expand" data-bs-original-title="Expand"></i><i id="delete1" class="bx bx-trash" data-bs-toggle="tooltip" data-bs-title="Delete body" aria-label="Delete" data-bs-original-title="Delete"></i></div><form id="formHorizontala1e9750a-e0ce-4e38-8372-406e5c8d0d94" class="horizontalFormForm flex-fill" style="margin-left: 0.5rem;"><div><div class="form-group jsonform-error-value horizontalFormDiv jsonform-readonly"><label for="-elt-value">classifying: </label><div class="controls"><input type="text" class="form-control" name="value" value="mrw (direct)" id="-elt-value" aria-label="classifying: " readonly="readonly"><span class="help-block jsonform-errortext" style="display:none;"></span></div></div><div class="form-group jsonform-error-id d-none"><label for="-elt-id">id</label><div class="controls"><input type="text" class="form-control" name="id" value="a1e9750a-e0ce-4e38-8372-406e5c8d0d94" id="-elt-id" aria-label="id"><span class="help-block jsonform-errortext" style="display:none;"></span></div></div></div></form></div></div><div class="row collapse"><form id="forma1e9750a-e0ce-4e38-8372-406e5c8d0d94" class="col"><div><fieldset class="form-group jsonform-error-  "><div class="form-group jsonform-error-id"><label for="-elt-id">id</label><div class="controls"><input type="text" class="form-control" name="id" value="a1e9750a-e0ce-4e38-8372-406e5c8d0d94" id="-elt-id" aria-label="id"><span class="help-block jsonform-errortext" style="display:none;"></span></div></div><div class="form-group jsonform-error-creators"><label for="-elt-creators">creators</label><div class="controls"><div id="-elt-creators"><ul class="_jsonform-array-ul" style="list-style-type:none;"><li data-idx="0"><div class="form-group jsonform-error-creators[0]"><label for="-elt-creators[0]">creators</label><div class="controls"><input type="text" class="form-control" name="creators[0]" value="Tester" id="-elt-creators[0]" aria-label="creators"><span class="help-block jsonform-errortext" style="display:none;"></span></div></div></li></ul><span class="_jsonform-array-buttons"><a href="#" class="btn btn-default _jsonform-array-addmore"><i class="glyphicon glyphicon-plus-sign" title="Add new"></i></a> <a href="#" class="btn btn-default _jsonform-array-deletelast"><i class="glyphicon glyphicon-minus-sign" title="Delete last"></i></a></span></div><span class="help-block jsonform-errortext" style="display:none;"></span></div></div><div class="form-group jsonform-error-created"><label for="-elt-created">created</label><div class="controls"><input type="text" class="form-control" name="created" value="2024-07-09T07:03:38.000Z" id="-elt-created" aria-label="created"><span class="help-block jsonform-errortext" style="display:none;"></span></div></div><div class="form-group jsonform-error-modified"><label for="-elt-modified">modified</label><div class="controls"><input type="text" class="form-control" name="modified" value="2024-07-09T07:03:38.000Z" id="-elt-modified" aria-label="modified"><span class="help-block jsonform-errortext" style="display:none;"></span></div></div><div class="form-group jsonform-error-purpose"><label for="-elt-purpose">purpose</label><div class="controls"><input type="text" class="form-control" name="purpose" value="classifying" id="-elt-purpose" aria-label="purpose"><span class="help-block jsonform-errortext" style="display:none;"></span></div></div><div class="form-group jsonform-error-value"><label for="-elt-value">value</label><div class="controls"><input type="text" class="form-control" name="value" value="mrw (direct)" id="-elt-value" aria-label="value"><span class="help-block jsonform-errortext" style="display:none;"></span></div></div></fieldset><input type="submit" class="btn btn-primary " value="Update + Save"></div></form></div></div><div id="bottomButtonContainer"></div></div>`;
