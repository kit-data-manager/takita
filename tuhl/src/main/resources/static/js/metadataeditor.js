...
editorDefinitionTable.prototype.initializeInputsTable = function (options, renderElt) {
    ...
    if (options.readIcon !== undefined && options.readIcon !== null && options.readIcon !== '') {
        this.readIcon = function () {return generateIcon(options.readIcon);};
    } else {
        this.readIcon = function () {return generateIcon(icons.EYE.BOXICON);};
    }

    if (options.editIcon !== undefined && options.editIcon !== null && options.editIcon !== '') {
        this.editIcon = function () {return generateIcon(options.editIcon);};
    } else {
        this.editIcon = function () {return generateIcon(icons.EDIT.BOXICON);};
    }

    if (options.deleteIcon !== undefined && options.deleteIcon !== null && options.deleteIcon !== '') {
        this.deleteIcon = function () {return generateIcon(options.deleteIcon);};
    } else {
        this.deleteIcon = function () {return generateIcon(icons.TRASH.BOXICON);};
    }

    if (options.listIcon !== undefined && options.lisIcon !== null && options.listIcon !== '') {
        this.listIcon = function () {return generateIcon(options.listIcon);};
    } else {
        this.listIcon = function () {return generateIcon(icons.LIST.BOXICON);};
    }
...
editorDefinitionTable.prototype.generateTable = function (options) {
    ...
    if (options.readOperation !== undefined) {
        this.items.push({formatter: this.readIcon, hozAlign: "center", width: 60, headerSort: false, cellClick: function (e, cell) {
                emptyElt(formElt);
    ...
    if (options.updateOperation !== undefined) {
        this.items.push({formatter: this.editIcon, hozAlign: "center", width: 60, headerSort: false, cellClick: function (e, cell) {
                emptyElt(formElt);
    ...
    if (options.deleteOperation !== undefined) {
        this.items.push({formatter: this.deleteIcon, hozAlign: "center", width: 60, headerSort: false, cellClick: function (e, cell) {
                emptyElt(formElt);
    ...
    if (options.listOperation !== undefined) {
        this.items.push({formatter: this.listIcon, hozAlign: "center", width: 60, headerSort: false, cellClick: function (e, cell) {
                emptyElt(formElt);
