 ...
 * @returns {undefined}
 */
const showModal = (type, message, link) => {
  var modelId;
  if (type === modalType.ALERT) {
    ...
    $(modelId + ' .btn').on('click', function () {
      window.location.href = window.CONTEXTPATH + link;
    });
...
editorDefinitionTable.prototype.initializeInputsTable = function (options, renderElt) {
  ...
  if (options.resource !== undefined && options.resource !== null && options.resource !== '') {
    ...
    options.readOperation !== undefined ||
    options.updateOperation !== undefined ||
    options.deleteOperation !== undefined
  ) {
  ...
  if (options.readIcon !== undefined && options.readIcon !== null && options.readIcon !== '') {
    ...
    this.readIcon = function () {
      return generateIcon(icons.EYE.BOXICON);
    };
  }
  ...
  if (options.editIcon !== undefined && options.editIcon !== null && options.editIcon !== '') {
    ...
    this.editIcon = function () {
      return generateIcon(icons.EDIT.BOXICON);
    };
  }
  ...
  if (options.deleteIcon !== undefined && options.deleteIcon !== null && options.deleteIcon !== '') {
    ...
    this.deleteIcon = function () {
      return generateIcon(icons.TRASH.BOXICON);
    };
  }
  ...
  if (options.listIcon !== undefined && options.lisIcon !== null && options.listIcon !== '') {
    ...
    this.listIcon = function () {
      return generateIcon(icons.LIST.BOXICON);
    };
  }
...
editorDefinitionForm.prototype.render = function (callback) {
  this.operation === operationType.READ
    ? this.generateReadForm()
    : this.operation === operationType.CREATE
      ? this.generateCreateForm(callback)
      : this.operation === operationType.UPDATE
        ? this.generateUpdateForm(callback)
        : this.operation === operationType.DELETE
          ? this.generateDeleteForm(callback)
          : _throw('Unknown operation!');
};
...
editorDefinitionTable.prototype.generateTable = function (options) {
  ...
  if (options.createOperation !== undefined) {
    var buttonTitle =
      options.createOperation.buttonTitle !== undefined ? options.createOperation.buttonTitle : buttons.CREATE.title;
  ...
  if (options.returnOperation !== undefined) {
    ...
    var buttonTitle =
      options.returnOperation.buttonTitle !== undefined ? options.returnOperation.buttonTitle : buttons.RETURN.title;
...
var generateButton = function (buttonId, buttonTitle, float) {
  return (
    '<button type="button" class="btn btn-primary" style="float:' +
    float +
    ';" id="' +
    buttonId +
    '">' +
...
editorDefinitionForm.prototype.generateCreateForm = function (callback) {
  this.renderElt.jsonForm({
    ...
    form: [
      ...
      {
        type: 'submit',
        title: this.operation.charAt(0) + this.operation.substring(1).toLowerCase() + ' + Save',
      },
    ],
...
(function (serverside, global, $, _, JSON) {
  ...
  jsonform.elementTypes = {
    ...
    'file-hosted-public': {
      ...
      onBeforeRender: function (data, node) {
        ...
        data.transloaditname =
          '_transloadit_jsonform_genericupload_public_' + node.ownerTree._transloadit_generic_public_index;
    ...
    selectfieldset: {
      ...
      onBeforeRender: function (data, node) {
        ...
        var elt = node.formElement;
        var tabs = '<select class="nav form-control"' + (node.disabled ? ' disabled' : '') + '>';
        _.each(children, function (child, idx) {
          tabs +=
            '<option data-idx="' +
            idx +
      ...
      while (node) {
        if (node.parentNode && node.parentNode.view && node.parentNode.view.array) {
          ...
          if (node.formElement && node.formElement.legend) {
            ...
            formData.idx =
              node.arrayPath.length > 0 ? node.arrayPath[node.arrayPath.length - 1] + 1 : node.childPos + 1;
  ...
  formTree.prototype.buildFromLayout = function (formElement, context) {
    ...
    if (formElement.key) {
      ...
      formElement.readOnly =
        formElement.readOnly || schemaElement.readOnly || formElement.readonly || schemaElement.readonly;
  ...
  $.fn.jsonForm = function (options) {
    ...
    if (options.transloadit) {
      formElt.append(
        '<input type="hidden" name="params" value=\'' + escapeHTML(JSON.stringify(options.transloadit.params)) + "'>",
      );
    }
