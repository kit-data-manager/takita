...
describe('creating a div for the information of a body (bodyCard)', () => {
  it('', () => {
    ...
    const $filledBodyCard = `<div class="card"><div class="row"><div id="bodyId" class="d-flex align-items-center formBodyDiv"><div id="iconRow1"><i id="expandexpand1" title="Expand" class="bx bx-chevron-right" data-bs-toggle="tooltip" data-bs-title="Expand body"></i><i id="delete1" title="Delete" class="bx bx-trash" data-bs-toggle="tooltip" data-bs-title="Delete body"></i></div><form id="formHorizontalbodyId" class="horizontalFormForm flex-fill" style="margin-left: 0.5rem;"></form></div></div><div class="row collapse"><form id="formbodyId" class="col"></form></div></div>`;
