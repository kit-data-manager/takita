...
describe('selecting an annotation', () => {
  ...
  describe('successfully and rendering it', () => {
    ...
    it('calls all the hooks', async () => {
      ...
      const preHorizontalBodyCardCreation = jest.fn((annotationId, body) => body);
