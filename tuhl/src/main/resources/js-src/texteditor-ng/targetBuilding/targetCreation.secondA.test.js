...
// and is supplemented by targetCreation.secondB.test.js (which tests the else branch)
describe('creating a string containing all the xPaths of a target', () => {
  it('holds three fully selected words', () => {
    ...
    expect(result).toBe('id("w.133") | id("w.134") | id("w.135")');
  });
});
