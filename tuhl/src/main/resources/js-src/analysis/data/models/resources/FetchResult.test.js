...
describe('fetched concept which has both parent and child concepts', () => {
  ...
  it('finds correct concept in graph', () => {
    const knownConcept = {
      ...
      'skos:definition': {
        lang: 'en',
        value: 'Use this domain for words related to animal husbandry--working with animals.',
      },
