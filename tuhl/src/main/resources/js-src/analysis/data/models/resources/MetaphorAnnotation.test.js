...
describe('metaphor annotation functionality', () => {
  ...
  test('extract MRW URIs', () => {
    const expected = [
      "http://localhost:8889/wap/philipp/takita/4e44c8bc-84ce-4b4b-9ef8-320c579d8470"
    ];
  ...
  test('filter out empty linking urls', () => {
    anno.analysis.linkings = [{
      source: 'foo', source_link: [null, 'https://example.com', null],
      target: 'bar', target_link: ['https://example.com', null], 
    }];
    ...
    const linkings = [
      {
        ...
        source:"sheep",source_link:["https://w3id.org/MoRe-SFB1475/CT/concepts/1356392694"],
        target:"believer",target_link:["https://w3id.org/MoRe-SFB1475/CT/concepts/3401688171"]
      },{
        source:"Gnu",source_link:[],
        target:"Penguin",target_link:["https://w3id.org/MoRe-SFB1475/CT/concepts/3765332836","https://w3id.org/MoRe-SFB1475/CT/concepts/803141091"]
      }
    ];
