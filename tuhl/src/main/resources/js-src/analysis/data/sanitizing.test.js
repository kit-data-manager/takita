...
describe('extractAuxText', () => {
  it('extracts text from beginning (where it normally is)', () => {
    ...
    expect(after).toBe(',"propositions":[],"mappings":[[{"source":{"value":"","step":null},"target":{"value":"","step":null}}]],"linkings":[{"source":"","source_link":[],"target":"","target_link":[]}],"tertiaComment":""}');
  });

  it('extracts aux text also if it is in the middle of the analysis string', () => {
    const string = '{"propositions":[],"auxiliaryText":{"ops":[{"insert":"Hello, this is not tricky.\\\\n"}]},"mappings":[[{"source":{"value":"","step":null},"target":{"value":"","step":null}}]],"linkings":[{"source":"","source_link":[],"target":"","target_link":[]}],"tertiaComment":""}';
    const { before, auxText, after } = extractAuxText(string);
    expect(before).toBe('{"propositions":[],"auxiliaryText":');
    expect(auxText).toBe('{"ops":[{"insert":"Hello, this is not tricky.\\\\n"}]}');
    expect(after).toBe(',"mappings":[[{"source":{"value":"","step":null},"target":{"value":"","step":null}}]],"linkings":[{"source":"","source_link":[],"target":"","target_link":[]}],"tertiaComment":""}');
  });
});
...
describe('extractTertiaComment', () => {
  it('extracts text from end (where it normally is', () => {
    ...
    expect(before).toBe('{"auxiliaryText":{},"propositions":[],"mappings":[[{"source":{"value":"","step":null},"target":{"value":"","step":null}}]],"linkings":[{"source":"","source_link":[],"target":"","target_link":[]}],"tertiaComment":');
    expect(tertiaComment).toBe('"This is not problematic.\\n"');
    expect(after).toBe('}');
  });

  it('extracts tertiaComment even if it is in the middle of the string', () => {
    const string = '{"auxiliaryText":{},"propositions":[],"mappings":[[{"source":{"value":"","step":null},"target":{"value":"","step":null}}]],"tertiaComment":"This is not problematic.\\n","linkings":[{"source":"","source_link":[],"target":"","target_link":[]}]}';
    const { before, tertiaComment, after } = extractTertiaComment(string);
    expect(before).toBe('{"auxiliaryText":{},"propositions":[],"mappings":[[{"source":{"value":"","step":null},"target":{"value":"","step":null}}]],"tertiaComment":');
    expect(tertiaComment).toBe('"This is not problematic.\\n"');
...
describe('splitInserts', () => {
  ...
  it.skip('deals with weird chinese text newlines (maybe just a relict of some manual tinkering with WAPS data?)', () => {
    const s = "{\"ops\":[{\"insert\":\"Reckon the \"},{\"attributes\":{\"mrw-direct\":true},\"insert\":\"boundaries \"},{\"insert\":\"of \"},{\"attributes\":{\"mrw-indirect\":true},\"insert\":\"glory and disgrace\"},{\"insert\":\"\\\n\"}]}";
    const r = splitInserts(s);
    console.log(r);
  });
});
...
describe('processTertiaComment', () => {
  ...
  it('deals with unproblematic text', () => {
    const s = '{"auxiliaryText":{},"propositions":[],"mappings":[[{"source":{"value":"","step":null},"target":{"value":"","step":null}}]],"linkings":[{"source":"","source_link":[],"target":"","target_link":[]}],"tertiaComment":"This is not problematic.\\n"}';
  ...
  it('deals with faulty newline escaping', () => {
    const s = '{"auxiliaryText":{},"propositions":[],"mappings":[[{"source":{"value":"","step":null},"target":{"value":"","step":null}}]],"linkings":[{"source":"","source_link":[],"target":"","target_link":[]}],"tertiaComment":"This is problematic.\\\\\n"}';
    const r = processTertiaComment(s);
    expect(() => JSON.parse(r)).not.toThrow();
  });
