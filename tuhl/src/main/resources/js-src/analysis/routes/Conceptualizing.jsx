...
const Conceptualizing = () => {
  ...
  return (
    <div className='Conceptualizing'>
      ...
      <p className='note'><i>Note: It has turned out that while sometimes it is very easy to find a tertium ("one source and target slot contain identical words"), in other cases it is very hard or even impossible (e.g. when the metaphor can not get resolved, but only expressed in terms of another, maybe more fundamental, metaphor). In addition, in the future we might want to analyse the presence (or absence) of such a "more fundamental" metaphor. That is why we figured that this dedicated analysis step might prove useful.</i></p>
