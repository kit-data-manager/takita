  ...
  const linkingContainers = l.map((l, idx) => {
    return (
      <LinkingContainer
        ...
        loggingFunction={(query, selectedURI, selectedRank) => storeSearchAnalytics(query, selectedURI, selectedRank, currentAppState.getId())}
      />
    );
  });
  ...
  return (
    <div className='Linking'>
      ...
      <p className='note' style={{margin: "15px 0"}}>
        <i>Note: The Concept Hierarchy as our point of reference is a major working area right now. A preliminary glance at the hierarchy is available at <a style={style} target="_blank" rel="noreferrer" href='https://w3id.org/MoRe-SFB1475/CT/'>https://w3id.org/MoRe-SFB1475/CT/</a>. If you want to propose changes to the hierarchy, please <a style={style} target="_blank" rel="noreferrer" href='https://gitlab.ruhr-uni-bochum.de/sfb-1475/tram/-/issues/new'>submit a TRAM Ticket</a>.
        </i>
      </p>
    </div>
  );
