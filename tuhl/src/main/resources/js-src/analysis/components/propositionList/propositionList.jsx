  ...
  return (
    <>
      <Select className='proposition-type' value={proposition.type || 'not-set'} onChange={onChangeType}>
        ...
        { Object.values(typeEnum).map(t => <option value={t} key={t}>{t}</option>) }
      </Select>
      { active && <>
      ...
      { active && props.textSlotB && <>
        <Input type='text' className='proposition-predicate' value={proposition.predicate} onChange={onChangePredicate} />
      ...
      { active &&  <>
        <Select className='proposition-evidence' value={proposition.evidence || evidenceEnum.explicit} onChange={onChangeEvidence}>
          { Object.values(evidenceEnum).map(e => <option value={e} key={e}>{e}</option>) }
        </Select>
...
export const PropositionList = ({ originalData, data, setData }) => {
